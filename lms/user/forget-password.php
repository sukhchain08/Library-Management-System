            ...
            <form method="POST">
                <div class="col-12 col-lg-4 text-center container-fluid">
                    <div class="issue-new-book-div border p-2 text-start">
                        ...
                        <div class="mt-3 mb-2">
                            <a href="../index.php" style="color: #1264a3; font-weight: 600; letter-spacing: .6px;" class="mb-3">Click here for login</a>
                        </div>
                        <?php   
                            ...
                            if(isset($_POST['get-password']))
                            {
                                ...
                                $query = mysqli_query($conn, "SELECT * FROM `user_data` WHERE number = '$number'");
