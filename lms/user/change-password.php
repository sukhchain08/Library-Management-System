<?php 
    ...
    if(isset($_POST['change-password']))
    {
        ...
        $old_password_result = mysqli_query($conn, "SELECT password FROM `user_data` WHERE number = $user_number ");
        ...
        if($old_password_row['password'] == $old_password)
        {
            ...
            {   
                ...
                $is_updated = mysqli_query($conn, "UPDATE `user_data` SET `password` = '$new_password' WHERE number='$user_number'");
    ...
    <section class="container-fluid py-3">
        ...
        <div class="col-lg-10">
            <div class="pagination">
                <pre class="d-flex">
                    <p>User</p> / <a href="dashboard.php">Dashboard</a> / <a href="change-password.php">Change Password</a>
                </pre>
            </div>
